...
import { GalleryModal } from '@features/modals/GalleryModal';
import { render, screen, within } from '@testing-library/react';
import React from 'react';
import { DatabaseContext } from '@app/providers/DatabaseContext';
...
describe('GalleryModal no-photo scenario', () => {
  ...
  beforeAll(() => {
    originalUseDatabaseService = require('@app/providers/DatabaseContext').useDatabaseService;
    require('@app/providers/DatabaseContext').useDatabaseService = () => mockDbService;
  });

  afterAll(() => {
    require('@app/providers/DatabaseContext').useDatabaseService = originalUseDatabaseService;
  });

...
describe("FishCaughtDisplay", () => {
  ...
  describe("Display Fish Catches", () => {
    ...
    it("displays additional details when present", () => {
      ...
      expect(
        screen.getByText("Beautiful rainbow trout caught in the morning"),
      ).toBeInTheDocument();
      expect(
        screen.getByText("Great fight on the fly rod"),
      ).toBeInTheDocument();
    });
    ...
    it("shows photo placeholder when photo is present", () => {
      ...
      expect(
        screen.getByText("Photo display will be available in a future update"),
      ).toBeInTheDocument();
    });
  });
  ...
  describe("Delete Functionality", () => {
    it("shows confirmation dialog when delete button is clicked", () => {
      ...
      expect(confirmSpy).toHaveBeenCalledWith(
        "Are you sure you want to delete this fish catch record?",
      );
  ...
  describe("Responsive Layout", () => {
    it("renders fish catch cards with proper structure", () => {
      ...
      const troutCard = screen
        .getByText("Rainbow Trout")
        .closest(".bg-gray-50");
      const brownTroutCard = screen
        .getByText("Brown Trout")
        .closest(".bg-gray-50");

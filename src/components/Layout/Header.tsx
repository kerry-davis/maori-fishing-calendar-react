...
const Header: FC<HeaderProps> = ({
  ...
  return (
    <div className="sticky top-0 z-40 backdrop-blur supports-[backdrop-filter]:bg-white/70 bg-white/90 dark:bg-gray-900/70 ring-1 ring-gray-200/60 dark:ring-white/10 rounded-b-2xl shadow-sm mb-8">
      <Container className="py-4">
        <div className="flex items-center justify-between gap-4">
          <div className="text-left">
            <h1 className="responsive-title text-2xl sm:text-3xl md:text-4xl font-semibold tracking-tight text-gray-900 dark:text-white">
